...
export class Specimen {
  ...
  constructor() {
    ...
    this.context ? this.context.font = 'italic 10pt Calibri' : console.log('Context is null cant assign font shape')
...
export function generateNextGeneration(selectedSpecimens: Specimen[], populationSize: number): Specimen[] {
